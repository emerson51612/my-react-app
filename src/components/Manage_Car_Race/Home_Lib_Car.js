...
function Home_Lib_Car() {
    ...
    const handleDelete = (id) => {
        var index = Races_Lib_Car.map(function(e) { return e.id; }).indexOf(id);
        Races_Lib_Car.splice(index, 1);
        history('/');
    };
    ...
    return (
        ...
        <div>
            <div className="navbar">
                ...
                <div className="title">Manage Car Race</div>
                ...
                <Table striped bordered hover size="sm">
                    ...
                    {Races_Lib_Car && Races_Lib_Car.length > 0 ? Races_Lib_Car.map((item) => (
                        <tr key={item.id}>
